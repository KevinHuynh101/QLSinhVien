...
import static data_sql.sinhvien.conn;
import static data_sql.sinhvien.pst;
import java.sql.*;
import javax.swing.*;
...
public static void themSV(String masv, String tensv,String Email, String SoDT, String GioiTinh, String DiaChi){
 ...
 public static void xoaSV(String masv){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Mã Sinh Viên "+masv+ " đã tồn tại, không thể xóa vì liên quan table khác","Thông báo",1);
        }
    }
}
